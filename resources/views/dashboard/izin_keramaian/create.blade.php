          ...
          <div class="card-header"><h4>Buat Surat Izin Keramaian</h4></div>
            <div class="card-body">
                ...
                <form action="{{ route('izin_keramaian.store') }}" method="POST" enctype='multipart/form-data'>
                    ...
                    <table class="table table-bordered datatable">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                  <div class="form-group">
                                    <input type="file" class="form-control-file" name="file_surat_permohonan" accept="image/png, image/jpeg" required/>
                                  </div>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <a class="btn btn-primary" href="{{ route('izin_keramaian.index') }}">Return</a>
                </form>
            </div>
          </div>
        </div>
